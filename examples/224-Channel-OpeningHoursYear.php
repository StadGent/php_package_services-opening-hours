 ...
 * @var string $openinghours_year_date
 */
...
example_print_header(
    'Example how to get the OpeningHours object for a single year'
    . PHP_EOL
...
try {
    $openingHours = $service->getYear($service_id, $channel_id, $openinghours_year_date);
